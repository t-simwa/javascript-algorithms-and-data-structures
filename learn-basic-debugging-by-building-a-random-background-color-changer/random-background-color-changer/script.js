const darkColorsArr = [ /* Array containing a list of dark color hex codes */
...
function getRandomIndex() { /* Function definition to generate a random index for the array */
...
const body = document.querySelector("body"); /* Selects the <body> element in the HTML document.
...
function changeBackgroundColor() { /* Function definition to change the background color of the page dynamically */
...
const btn = document.querySelector("#btn"); /* Selects the button element with the ID 'btn':
...
btn.onclick = changeBackgroundColor; /* Assigns the `changeBackgroundColor` function to the `onclick` event of the button:
